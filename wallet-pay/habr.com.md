...
Покупателю нужно предоставить ссылку для оплаты счета за товары/услуги вашего бота через WalletPay. Код для получения этой ссылки может быть таким.
...
-   периодический опрос [состояния счета](https://docs.wallet.tg/pay/#tag/Order/operation/getPreview)
